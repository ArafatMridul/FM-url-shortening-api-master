...
const Footer = () => {
    return (
        <footer className="bg-n-g-4">
            <div className="wrapper lg:flex">
                <div className="pt-13 lg:pt-18">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="121"
                        height="33"
                        className="mx-auto lg:mx-0 hover:cursor-pointer"
                    >
                        <path
                            fill="#FFFFFF"
                ...
                <div className="mt-12 flex-1 lg:flex lg:gap-16 lg:mt-8 lg:pl-65">
                    {footerNav.map(({ name, subLinks }, index) => (
                        <div key={index} className="last:lg:pl-10">
                            <div className="mb-6 mt-10">
                                <h2 className="text-center lg:text-start text-white hover:cursor-pointer">
                                    {name}
                                </h2>
                            </div>
                            <div>
                                <ul>
                                    {subLinks.map((link, index) => (
                                        <li
                                            key={index + 10}
                                            className="text-center lg:text-start text-n-g-2 mt-2 hover:text-p-b transition-colors duration-300 cursor-pointer"
                                        >
                                            {link}
                                        </li>
                                    ))}
                ...
                <div className="flex items-center lg:items-start justify-center gap-6 mt-10 lg:mt-19 pb-14 lg:pb-53">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        className="fill-white hover:fill-p-b cursor-pointer transition-colors duration-300"
                    >
